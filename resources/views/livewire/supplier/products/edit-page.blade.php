            ...
            <div class="px-4 py-8 bg-white shadow rounded-lg">
                ...
                <form wire:submit.prevent="updateProduct">
                    ...
                    <div class="mb-4">
                        ...
                        <select wire:model.live="status" id="status" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('status') border-red-300 text-red-900 @enderror">
